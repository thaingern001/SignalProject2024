...
filename = "piano/10 Must-Know Piano Chords for Beginners.mp3"
...
ans15 = []
ans20 = []
chord_progression = sound_to_chords(filename,5)

chord_progression = sound_to_chords(filename,10)
for time, chord in chord_progression:
    ans10.append(chord)
chord_progression = sound_to_chords(filename,15)
for time, chord in chord_progression:
    ans15.append(chord)
...
# print(ans20)
# พิมพ์หัวตาราง
print("ans5".ljust(20), "ans10".ljust(20), "ans15".ljust(20), "ans20".ljust(20))

# พิมพ์ค่าของแต่ละคอลัมน์
for a5, a10, a15, a20 in zip(ans5, ans10, ans15, ans20):
    print(a5.ljust(20), a10.ljust(20), a15.ljust(20), a20.ljust(20))
