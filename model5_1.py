...
chord_progression = sound_to_chords(filename,20,0.5,0.25)
for time, chord in chord_progression:
    ans10.append(chord)
chord_progression = sound_to_chords(filename,20,0.2,0.1)
for time, chord in chord_progression:
    ans15.append(chord)
chord_progression = sound_to_chords(filename,20,0.4,0.2)
for time, chord in chord_progression:
    ans20.append(chord)
